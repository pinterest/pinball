...
Sql statements creating database tables can be auto-generated from the models
by running the following command:
PYTHONPATH=. python manage.py sql --settings=pinball.config.settings \
    persistence

Database tables can be created by running:
PYTHONPATH=. python manage.py syncdb \
    --settings=pinball.config.settings

Sql statements removing the database tables can be generated by running:
PYTHONPATH=. python manage.py sqlclear \
    --settings=pinball.config.settings persistence
"""
